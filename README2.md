...
4. [Setting Up Wazuh](#setting-up-wazuh)
5. [Setting Up TheHive](#setting-up-thehive)
6. [Configuration](#configuration)
7. [Generating Telemetry and Configuring Sysmon](#generating-telemetry-and-configuring-sysmon)
8. [Automating with Shuffle](#automating-with-shuffle)
